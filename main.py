...
# ToDo: validate if SELL is happening near market open time and if BUY is happening near market close time
...
if get_symbol_last_price(symbol):
    ...
    logging.warning("Cannot get the last 15-minute delayed price for symbol!")
